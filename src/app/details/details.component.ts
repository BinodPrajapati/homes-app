...
@Component({
  ...
  template: ` <article>
    ...
    <section class="listing-apply">
      <h2 class="listing-heading">Apply now to leave here</h2>
...
export class DetailsComponent {
  ...
  constructor() {
    const housingLicationId = Number(this.route.snapshot.params["id"]);
    if (housingLicationId) {
      console.log(housingLicationId);
    }
